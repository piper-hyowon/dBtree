...
// +kubebuilder:rbac:groups=dbtree.dbtree.cloud,resources=dbinstances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dbtree.dbtree.cloud,resources=dbinstances/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=dbtree.dbtree.cloud,resources=dbinstances/finalizers,verbs=update
